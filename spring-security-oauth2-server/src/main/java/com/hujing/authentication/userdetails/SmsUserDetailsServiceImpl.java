 ...
 */
@Component("smsUserDetailsServiceImpl")
public class SmsUserDetailsServiceImpl extends AbstractUserDetailsServiceImpl {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        //1.根据用户名获取用户
        TbUser user = tbUserMapper.selectOne(Wrappers.<TbUser>query().eq("phone", username));
        if (user != null) {
